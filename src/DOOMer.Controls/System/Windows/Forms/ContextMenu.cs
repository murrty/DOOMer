...
///     Although <see cref="T:System.Windows.Forms.ContextMenuStrip" /> replaces and adds functionality to the
///     <see cref="T:System.Windows.Forms.ContextMenu" /> control of previous versions,
///     <see cref="T:System.Windows.Forms.ContextMenu" /> is retained for both backward compatibility and future use if you choose.
/// </summary>
[DefaultEvent("Popup")]
...
public class ContextMenu : Menu {
    ...
    private void Show(Control control, Point pos, int flags) {
        ...
        SafeNativeMethods.TrackPopupMenuEx(new HandleRef(this, base.Handle), flags, pos.X, pos.Y, new HandleRef(control, control.Handle), 0);
    }
}
#endif
