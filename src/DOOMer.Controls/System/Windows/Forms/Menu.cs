...
///     Although <see cref="T:System.Windows.Forms.ToolStripDropDown" /> and
///     <see cref="T:System.Windows.Forms.ToolStripDropDownMenu" /> replace and add functionality to the
///     <see cref="T:System.Windows.Forms.Menu" /> control of previous versions,
///     <see cref="T:System.Windows.Forms.Menu" /> is retained for both backward compatibility and future use if you choose.
/// </summary>
...
public abstract class Menu : Component {
    ...
    public class MenuItemCollection : IList, ICollection, IEnumerable {
        ...
        /// <exception cref="T:System.ArgumentException">The <paramref name="index" /> parameter is less than zero.  
        ///  or  
        ...
        public virtual int Add(int index, MenuItem item) {
            ...
            if (owner.items.Length == owner.ItemCount) {
    ...
    internal void UpdateImages() {
        int VisibleIndex = 0;
        HandleRef menuHandle = new(this, handle);
        ...
        for (int i = 0; i < MenuItems.Count; i++) {
            ...
            if (m.Image != null || m.MenuItemBitmap != MenuItemBitmapType.UserDefined) {
